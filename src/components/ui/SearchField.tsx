...
export default function SearchField({ accessibilityLabel, onChangeText, onClear, placeholder, value }: SearchFieldProps): ReactElement {
  return (
    <View style={styles.container}>
      ...
      <TextInput accessibilityLabel={accessibilityLabel} autoCapitalize="none" autoCorrect={false} onChangeText={onChangeText} placeholder={placeholder} placeholderTextColor={COLORS.inkMuted} returnKeyType="search" style={styles.input} value={value} />
...
const styles = StyleSheet.create({
  container: { alignItems: "center", backgroundColor: COLORS.surfaceMuted, borderColor: COLORS.border, borderRadius: RADII.small, borderWidth: 1, flex: 1, flexDirection: "row", minHeight: MINIMUM_TOUCH_SIZE, paddingLeft: SPACING.medium },
